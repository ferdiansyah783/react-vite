  ...
  return (
    <div className="w-full h-screen fixed z-50 font-poppins bg-black bg-opacity-20">
      <div className="w-full h-full relative">
        <div ref={ref} className="w-3/4 h-auto flex flex-col items-center space-y-5 px-4 py-5 absolute left-[12.5%] top-[20%] bg-white rounded-xl md:w-1/4 md:left-[37.5%] md:space-y-7 md:px-3 md:py-7 md:top-1/3">
